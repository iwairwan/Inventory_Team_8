 ...
 * @author RavenPC
 */
public class Form_LaporanBarangMasuk extends javax.swing.JPanel {
    ...
    public Form_LaporanBarangMasuk(String Id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih Jenis Laporan --", "Per Transaksi", "Per Periode", "Per Bulan" }));
        ...
        pn_lap1.add(pn_pertransaksi1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 94, -1, 140));
        ...
        pn_lap1.add(pn_pertransaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 94, -1, 140));
        ...
        pn_lap1.add(pn_perperiode, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 94, -1, 140));
        ...
        pn_lap1.add(pn_perbulan, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 94, -1, 140));
        ...
        pn_lap1.add(pn_perdistributor, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 94, -1, 140));
...
//        resetForm();
    ...
    private void cetak_notransMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cetak_notransMouseClicked
        ...
        servis_lap.lapBarangMasukPerTransaksi(pn_lap, no);
    ...
    private void brw_transaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brw_transaksiActionPerformed
        ...
        Data_BarangMasuk dat_masuk = new Data_BarangMasuk(null, closable);
        dat_masuk.setVisible(true);

        t_no.setText     (dat_masuk.msk.getNo_masuk());
...
//            pn_perdistributor.setVisible(true);
    ...
    private void cetak_periodeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cetak_periodeMouseClicked
        ...
        servis_lap.lapBarangMasukPeriode(pn_lap, tgl1, tgl2);
    ...
    private void cetak_perbulanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cetak_perbulanMouseClicked
        ...
        servis_lap.lapBarangMasukPerbulan(pn_lap, bulan, tahun);
    ...
    private void cetak_distributorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cetak_distributorMouseClicked
        ...
        servis_lap.lapBarangMasukPerDistributor(pn_lap, id_dis);
    ...
    private void brw_distributorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brw_distributorActionPerformed
        ...
        t_dis.setText     (dat_masuk.dst.getId_distributor());
    ...
    private void tampilPanel(){
        ...
        mainPanel.add(new Form_LaporanBarangMasuk(Id));
        mainPanel.repaint();
