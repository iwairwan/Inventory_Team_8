 ...
 * @author RavenPC
 */
public class Form_LaporanDataPengguna extends javax.swing.JPanel {
    
    private Connection conn;

    private Service_Laporan servis_lap = new DAO_Laporan();
    
    public Form_LaporanDataPengguna(String Id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Data Pengguna");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih Jenis Laporan --", "Laporan Data Master Pengguna", " " }));
        ...
        jLabel7.setText("Laporan Data Master Pengguna");
...
//        resetForm();
    ...
    private void cetak_notransMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cetak_notransMouseClicked
        ...
        servis_lap.lapDataPengguna(pn_lap);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        }else if(jComboBox1.getSelectedItem()=="Laporan Data Master Pengguna"){
...
//            pn_laptransbarang.setVisible(true);
    ...
    private void tampilPanel(){
        ...
        mainPanel.add(new Form_LaporanDataPengguna(Id));
        mainPanel.repaint();
