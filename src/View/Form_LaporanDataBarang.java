 ...
 * @author RavenPC
 */
public class Form_LaporanDataBarang extends javax.swing.JPanel {
    
    private Connection conn;

    private Service_Laporan servis_lap = new DAO_Laporan();
    
    public Form_LaporanDataBarang(String Id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih Jenis Laporan --", "Laporan Data Barang", "Laporan Transaksi Barang" }));
...
//        resetForm();
    ...
    private void cetak_notransMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cetak_notransMouseClicked
        ...
        servis_lap.lapDataBarang(pn_lap);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        }else if(jComboBox1.getSelectedItem()=="Laporan Data Barang"){
            pn_lapbarang1.setVisible(false);
            pn_lapbarang.setVisible(true);
            pn_laptransbarang.setVisible(false);
        }else if(jComboBox1.getSelectedItem()=="Laporan Transaksi Barang"){
            pn_lapbarang1.setVisible(false);
            pn_lapbarang.setVisible(false);
    ...
    private void tampilPanel(){
        ...
        mainPanel.add(new Form_LaporanDataBarang(Id));
        mainPanel.repaint();
